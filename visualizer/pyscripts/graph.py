...
ax = fig1.add_axes([0.1, 0.1, 0.7, 0.75])
plt.title("Number of Servers in Each Sleep State")
...
plt.legend((p1[0],p2[0],p3[0],p4[0],p5[0]),(header[0], header[1], header[2], header[3], header[4]),bbox_to_anchor=(1.02,1), loc='upper left', fontsize=12, ncol=1, framealpha=0, fancybox=True)
...
ax = fig2.add_axes([0.1, 0.1, 0.7, 0.75])
