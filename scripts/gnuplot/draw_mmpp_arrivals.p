...
set output '| ps2pdf - ./mmpp_arrivals_p0.8.pdf'
#set grid
set size ratio 0.5
set autoscale y
...
set yrange [0:10000]
set ylabel "number of job generated" font "Times-Roman,18" offset 2 
#set xtics 100
set ytics 1000
set key off
#set style line lw 2
plot "mmpp_arrivals_stats_p0.8" using ($1):($0) with lines lw 3 lc 3 
