 ...
 * @author fan
 */
public class TestFlowTopologyGen extends AbstractTopologyGen {
	...
	public Vector<Vector<Integer>> getNodeConnectivity() {
		...
		Vector<Integer> lst0 = new Vector<Integer>(Arrays.asList(0,oo,10,10,10,oo,oo,oo,oo));
		Vector<Integer> lst1 = new Vector<Integer>(Arrays.asList(oo,0,10,oo,oo,10,10,10,oo));
		Vector<Integer> lst2 = new Vector<Integer>(Arrays.asList(10,10,0,oo,oo,oo,oo,oo,10));
		Vector<Integer> lst3 = new Vector<Integer>(Arrays.asList(10,oo,oo,0,oo,oo,oo,oo,oo));
		Vector<Integer> lst4 = new Vector<Integer>(Arrays.asList(10,oo,oo,oo,0,oo,oo,oo,oo));
		Vector<Integer> lst5 = new Vector<Integer>(Arrays.asList(oo,10,oo,oo,oo,0,oo,oo,oo));
		Vector<Integer> lst6 = new Vector<Integer>(Arrays.asList(oo,10,oo,oo,oo,oo,0,oo,oo));
		Vector<Integer> lst7 = new Vector<Integer>(Arrays.asList(oo,10,oo,oo,oo,oo,oo,0,oo));
		Vector<Integer> lst8 = new Vector<Integer>(Arrays.asList(oo,oo,10,oo,oo,oo,oo,oo,0));
		...
		nodeConnectivity.add(lst7);
		nodeConnectivity.add(lst8);
...
//	}
	public Vector<Vector<Integer>> getNodePortsMapping() {
		...
		Vector<Integer> lst0 = new Vector<Integer>(Arrays.asList(-1,-1,1,2,3,-1,-1,-1,-1));
		Vector<Integer> lst1 = new Vector<Integer>(Arrays.asList(-1,-1,1,-1,-1,2,3,4,-1));
		Vector<Integer> lst2 = new Vector<Integer>(Arrays.asList(1,2,-1,-1,-1,-1,-1,-1,3));
		Vector<Integer> lst3 = new Vector<Integer>(Arrays.asList(1,-1,-1,-1,-1,-1,-1,-1,-1));
		Vector<Integer> lst4 = new Vector<Integer>(Arrays.asList(1,-1,-1,-1,-1,-1,-1,-1,-1));
		Vector<Integer> lst5 = new Vector<Integer>(Arrays.asList(-1,1,-1,-1,-1,-1,-1,-1,-1));
		Vector<Integer> lst6 = new Vector<Integer>(Arrays.asList(-1,1,-1,-1,-1,-1,-1,-1,-1));
		Vector<Integer> lst7 = new Vector<Integer>(Arrays.asList(-1,1,-1,-1,-1,-1,-1,-1,-1));
		Vector<Integer> lst8 = new Vector<Integer>(Arrays.asList(-1,-1,1,-1,-1,-1,-1,-1,-1));
		...
		nodePortsMapping.add(lst7);
		nodePortsMapping.add(lst8);
